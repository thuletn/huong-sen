...
<body>
                            ...
                            <div class="navbar-header pull-left">
                                <div class="logo-block">
                                    <a href="<?php echo base_url(); ?>trangchu" class="site-logo">
                                        <img src="<?php echo base_url(); ?>fileupload/logo.png" alt="sitelogo" class="logo" style="width: 50px; height: 50px;">
                                    </a><!--/.site-logo-->
                                </div>
                            </div><!--/.navbar-header-->
    ...
    <div class="container">
        <div class="col-md-12">
            <div class="section-title-area style-two">
                <h2 class="section-title  text-center" style="margin-top:20px">Giới Thiệu</h2>
                    ...
                    <div class="widget-area footer-sidebar-top-4">
                        <aside class="widget clearfix widget_social_media">
                            ...
                            <div class="widget-social">
                                <a href="<?= $value['fb'] ?>"><i class="fa fa-facebook"></i></a>
                                <a href="<?= $value['twitter'] ?>"><i class="fa fa-twitter"></i></a>
                                <a href="<?= $value['ggplus'] ?>"><i class="fa fa-google-plus"></i></a>
